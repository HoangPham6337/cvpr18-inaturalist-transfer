...
from utility import SpeciesDict, read_species_from_json, write_species_to_json
...
def cross_reference(
    ...
    try:
        ...
        print(f"Cross-reference result saved to {output_path}.")
...
if __name__ == "__main__":
    ...
    match_species, total_matches = cross_reference(
        dataset_1, dataset_2, species_set_1, species_set_2, OUTPUT_PATH
    )

    write_species_to_json("output/matched_species_Aves_Insecta.json", match_species)
