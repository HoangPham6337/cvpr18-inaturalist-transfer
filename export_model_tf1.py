...
from tensorflow.saved_model import tag_constants, signature_constants, signature_def_utils
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    # Define the model #
    ####################
    input_ph = tf.placeholder(dtype=tf.float32, shape=[None, 299, 299, 3], name="input")
    logits, _ = network_fn(input_ph)
